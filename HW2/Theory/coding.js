function display2_1() {
  var myanswer  = "My answer goes here: undefined, True, False. \n Explanation: null is an assigned value that means nothing. undefined is a declared variable that is unassigned a value. So both aren't primitive however they are not the same type." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: causes an error because x wasn't declared." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: (.children) will give all elements enclosed by the div with the id=1134. Also in the html code exists a style (display: none) which makes the elements invisible howerver still enclosed in the div. )" // TODO 2.5: Fill in Answer here
